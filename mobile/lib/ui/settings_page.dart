          ...
          child: Column(
            ...
            children: [
              const Row(children: [
                ...
                SizedBox(width: 8),
                Text('GitHub Personal Access Token', style: TextStyle(color: H.text, fontWeight: FontWeight.w600)),
              ]),
          ...
          child: Column(
            ...
            children: [
              const Row(children: [
                ...
                SizedBox(width: 8),
                Text('Gemini API Key (Google)', style: TextStyle(color: H.text, fontWeight: FontWeight.w600)),
              ]),
              const SizedBox(height: 12),
