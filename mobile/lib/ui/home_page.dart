      ...
      child: ListView(
        ...
        children: [
          ...
          GlassCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Expanded(child: ActionBtn(icon: Icons.chat_bubble_rounded, label: 'Chat with Gemini', onTap: onOpenChat)),
              const SizedBox(width: 10),
              Expanded(child: ActionBtn(icon: Icons.folder_rounded, label: 'Browse repos', onTap: onOpenRepos)),
            ]),
          ])),
        ],
      ),
...
class ActionBtn extends StatelessWidget {
  const ActionBtn({required this.icon, required this.label, required this.onTap});
  final IconData icon;
  final String label;
